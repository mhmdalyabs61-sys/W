...
AZKAR_LIST = [
    ...
    "📜 | **قال رسول الله صلى الله عليه وسلم: (أحب الكلام إلى الله أربع: سبحان الله، والحمد لله، ولا إله إلا الله، والله أكبر، لا يضرك بأيهن بدأت).**",

    # ── أذكار الصباح والمساء والحماية ──
    "🌙 | **أَصْـبَحنا وَأَصْـبَح المُلْكُ لله، والحمدُ لله، لا إله إلا اللهُ وحدَهُ لا شريكَ له، له المُلْكُ وله الحَمْد، وهو على كل شيء قدير.**",
    "🛡️ | **بِسْمِ اللَّهِ الَّذِي لَا يَضُرُّ مع اسمِهِ شيءٌ في الأرضِ ولَا في السماءِ وهو السَّميعُ العليم (3 مرات).**",
    "⭐ | **اللهم أنت ربي لا إله إلا أنت، خلقتني وأنا عبدك، وأنا على عهدك ووعدك ما استطعت، أعوذ بك من شر ما صنعت، أبوء لك بنعمتك علي، وأبوء لك بذنبي فاغفر لي فإنه لا يغفر الذنوب إلا أنت.**",
    "☀️ | **يَا حَيُّ يَا قَيُّومُ، بِرَحْمَتِكَ أَسْتَغِيثُ، أَصْلِحْ لي شَأْني كُلَّهُ، وَلا تَكِلْني إلى نَفْسِي طَرفَةَ عَيْنٍ.**",
    "🛡️ | **اللهم إني أسألك العفو والعافية في الدنيا والآخرة، اللهم إني أسألك العفو والعافية في ديني ودنياي وأهلي ومالي.**",
    "🛡️ | **أعوذ بكلمات الله التامات من شر ما خلق.**",

    # ── أذكار النوم والاسترخاء ──
    "🛌 | **باسْمِكَ رَبِّي وَضَعْتُ جَنْبِي، وَبِكَ أَرْفَعُهُ، إِنْ أَمْسَكْتَ نَفْسي فَارْحَمْهَا، وَإنْ أَرْسَلْتَهَا فاحْفَظْهَا بمَا تَحْفَظُ به عِبَادَكَ الصَّالِحين.**",
    "🌙 | **اللهم أسلمت نفسي إليك، وفوضت أمري إليك، وألجأت ظهري إليك رغبة ورهبة إليك، لا ملجا ولا منجا منك إلا إليك، آمنت بكتابك الذي أنزلت وبنبيك الذي أرسلت.**",
    ...
    # ── آيات وأدعية قرآنية مباركة ──
    "📖 | **رَبَّنَا آتِنَا فِي الدُّنْيَا حَسَنَةً وَفِي الْآخِرَةِ حَسَنَةً وَقِنَا عَذَابَ النَّارِ.**",
    "📖 | **رَبِّ اجْعَلْنِي مُقِيمَ الصَّلَاةِ وَمِن ذُرِّيَّتِي ۚ رَبَنَا وَتَقَبَّلْ دُعَاءِ.**",
    "📖 | **رَبَّنَا لَا تُزِغْ قُلُوبَنَا بَعْدَ إِذْ هَدَيْتَنَا وَهَبْ لَنَا مِلدُنكَ رَحْمَةً ۚ إنَّكَ أَنتَ الْوَهَّابُ.**",
...
async def send_automatic_azkar():
    for guild_id, channel_id in list(AZKAR_CHANNELS.items()):
        ...
        try:
            ...
            print(f"خطأ في إرسال الذكر للسيرفر {guild.name}: {e}")
