...
JAIL_ROLE_ID = 1551727301543333888
...
AZKAR_LIST = [
    ...
    "🍂 | **رَبنا آتنا في الدنيا حسنة وفي الآخرة حسنة وقنا عذاب النار**",
    ...
    "🌙 | **سبحان الله الـعظيم وبحمده، استغفر الله وأتوب إليه**",
    ...
    "🌿 | **لا إله إلا الله وحد لا شريك له له الملك وله الحمد يحيي ويميت وهو على كل شيء قدير**",
    "✨ | **سبحان الله وبحمده عدد الشجر وعدد الحجر وعدد رمل المطر**",
    "🤍 | **الحمد لله الذي بنعمته تتم الصالحات**",
    "🌹 | **سُبحان الله، والحمْدُ لله، ولا إله إلا الله، والله أكبَر، ولا حول ولا قوّة إلا بالله**",
    "🌙 | **اللهم اكفني بحلالك عن حرامك وأغنني بفضلك عمن سواك**",
    "⭐ | **اللهم إني أسألك الجنة بغير حساب ولا سابقة عذاب**",
    "🍃 | **لا إله إلا الله الحليم الكريم، سبحان الله رب العرش العظيم**",
    "💧 | **اللهم اغفر لي خطيئتي وجهلي وإسراففي في أمري كله**",
    "☀️ | **سبحان الله وبحمده عدد خلقك ورضا نفسك**",
    "🌙 | **ربنا آتنا في الدنيا حسنة وفي الآخرة حسنة وقنا عذاب النار**",
    "💎 | **لا حول ولا قوة إلا بالله العلي العظيم توكلت على الله**"
]
...
class RoomOrganizer(commands.Cog):
